...
public class SceneBootstrapper
{
    ...
    const string k_LoadBootstrapSceneOnPlay = "TurnBasedGame/Load Bootstrap Scene On Play";
    const string k_DoNotLoadBootstrapSceneOnPlay = "TurnBasedGame/Don't Load Bootstrap Scene On Play";
